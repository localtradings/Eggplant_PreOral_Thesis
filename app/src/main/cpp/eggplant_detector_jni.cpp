...
Java_com_eggplant_detector_detection_NativeNcnnBridge_hasVulkan(JNIEnv*, jobject) {
    ensure_gpu_instance();
    return ncnn::get_gpu_count() > 0 ? JNI_TRUE : JNI_FALSE;
}

extern "C" JNIEXPORT jlong JNICALL
Java_com_eggplant_detector_detection_NativeNcnnBridge_create(
    JNIEnv* env,
    jobject,
    jstring param_path,
    jstring bin_path,
...
Java_com_eggplant_detector_detection_NativeNcnnBridge_detect(
    JNIEnv* env,
    jobject,
    jlong handle,
...
Java_com_eggplant_detector_detection_NativeNcnnBridge_destroy(JNIEnv*, jobject, jlong handle) {
